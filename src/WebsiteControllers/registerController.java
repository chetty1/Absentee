        ...
        if (absentbool) {
           ...
           plate= plate.normalizedStandard(PeriodType.time());
            ...
            if (days.equals("Friday")) {
                ...
                String totaltimesite = addTime(hrsOnsiteLocal, Period.parse(getHoursandMinWorked(beforeTime, afterTime), hoursMinutes).plusMinutes(15).normalizedStandard(PeriodType.time()).toString(hoursMinutes));
                ...
                String totaltimesite = addTime(hrsOnsiteLocal, Period.parse(getHoursandMinWorked(beforeTime, afterTime), hoursMinutes).minusMinutes(15).normalizedStandard(PeriodType.time()).toString(hoursMinutes));

...
public class statsController {
    ...
    public ModelAndView post() throws ParseException {
        ...
        TreeMap<String, Integer> absentdayFreq = new TreeMap<>();
        TreeMap<String, Integer> leaveDayFreq = new TreeMap<>();
        TreeMap<String, Integer> typeFreq = new TreeMap<>();
        TreeMap<String, Integer> staffFreq = new TreeMap<>();
        TreeMap<String, Integer> staffleaveFreq = new TreeMap<>();
        TreeMap<String, OverView> overtimeComp = new TreeMap<>();

        TreeMap<String, OverView> salesComp = new TreeMap<>();
        TreeMap<String, OverView> elecComp = new TreeMap<>();
        TreeMap<String, OverView> machineComp = new TreeMap<>();
        TreeMap<String, OverView> boilerComp = new TreeMap<>();
        TreeMap<String, OverView> fittingComp = new TreeMap<>();
        TreeMap<String, OverView> storesComp = new TreeMap<>();
        TreeMap<String, OverView> drawingComp = new TreeMap<>();
        TreeMap<String, OverView> officeComp = new TreeMap<>();
        ...
        for (Map.Entry<String, OverView> entry : overtimeComp.entrySet()) {
            String name = entry.getValue().getStaff().getName();
            OverView view = entry.getValue();

            switch (entry.getValue().getStaff().getDepartment()) {


                case "Sales":
                    salesComp.put(name, view);
                    break;
                case "Electrical":
                    elecComp.put(name, view);
                    break;
                case "Machine Shop":
                    machineComp.put(name, view);

                    break;
                case "Boiler Shop":

                    boilerComp.put(name, view);

                    break;
                case "Fitting":
                    fittingComp.put(name, view);

                    break;
                case "Stores":
                    storesComp.put(name, view);
                    break;
                case "Drawing":
                    drawingComp.put(name, view);
        ...
        modelAndView.addObject("salesFreq", salesComp);
        modelAndView.addObject("electricalFreq", elecComp);
        modelAndView.addObject("machineFreq", machineComp);
        modelAndView.addObject("boilerFreq", boilerComp);
        modelAndView.addObject("fittingFreq", fittingComp);
        modelAndView.addObject("storesFreq", storesComp);
        modelAndView.addObject("drawingFreq", drawingComp);
        modelAndView.addObject("officeFreq", officeComp);
    ...
    public void addToMap(TreeMap<String, Integer> map, String leave, String key) {
    ...
    public void addComptoMap(TreeMap<String, OverView> map, OverView view) {
    ...
    public void addTypeToMap(TreeMap<String, Integer> map, OverView view) {
